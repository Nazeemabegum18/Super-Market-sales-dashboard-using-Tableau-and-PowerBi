...
The dataset originally had around 51k records, but I sampled it down to 3k rows after cleaning so it was easier to work with for visualisation.
Key information includes:

1. Sales, Profit, Quantity
2. Shipping Cost and Mode
3. Product Category & Sub-category
4. Market, Region, and Year
5. Customer Segments
